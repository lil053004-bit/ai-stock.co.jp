  ...
  return (
    <div className="relative w-40 h-40 sm:w-48 sm:h-48 md:w-64 md:h-64 mx-auto animate-robot-float transition-transform hover:scale-110 duration-300">
      <svg
        ...
        style={{ filter: 'drop-shadow(0 0 10px rgba(100, 116, 139, 0.3))' }}
      >
        <defs>
        ...
        <g className="robot-body">
          ...
          <circle cx="85" cy="75" r="4" fill="#334155" className="robot-pupil-left" />
          ...
          <circle cx="115" cy="75" r="4" fill="#334155" className="robot-pupil-right" />
          ...
          <rect x="75" y="30" width="8" height="20" rx="4" fill="#475569" />
          <circle cx="79" cy="25" r="5" fill="#94a3b8" />
        ...
        <g className="book-group animate-book-read" transform="translate(70, 140)">
          <rect
            ...
            strokeWidth="2"
          />
          <line x1="30" y1="0" x2="30" y2="45" stroke="#cbd5e1" strokeWidth="2" />
        ...
        <g className="magnifier-group animate-magnifier-scan">
          <circle cx="30" cy="165" r="18" fill="rgba(255,255,255,0.2)" stroke="#f59e0b" strokeWidth="3" />
          <circle cx="30" cy="165" r="12" fill="rgba(255,255,255,0.4)" />
          <line x1="42" y1="177" x2="52" y2="187" stroke="#f59e0b" strokeWidth="3" strokeLinecap="round" />
        </g>

        <circle cx="100" cy="50" r="30" fill="rgba(100,116,139,0.1)">
